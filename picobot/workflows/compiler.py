            ...
            nodes.append(
                {
                    ...
                    "config": {
                        "harness": harness,
                        "shared_tab_required": True,
                        "contract": {"input": "shared_tab", "output": "source_summary"},
                    },
                    "x": 330,
                    "y": 220,
                }
            ...
            [
                {
                    ...
                    "config": {
                        "harness": harness,
                        "brief": clean_brief,
                        "contract": {"input": "brief", "output": "text"},
                    },
                ...
                },
                {
                    ...
                    "config": {
                        "harness": harness,
                        "contract": {"input": "decision", "output": "decision"},
                    },
                ...
                },
                {
                    ...
                    "config": {
                        ...
                        "content_from": "previous_output",
                        "requires_owner_content": True,
                        "contract": {"input": "previous_output", "output": "artifact"},
                    },
