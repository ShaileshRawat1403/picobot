...
class SkillsLoader:
    ...
    def _parse_picobot_metadata(self, raw: str) -> dict:
        """Parse skill metadata JSON from frontmatter (supports picobot and openclaw keys)."""
        try:
            data = json.loads(raw)
            return data.get("picobot", data.get("openclaw", {})) if isinstance(data, dict) else {}
    ...
    def _get_skill_meta(self, name: str) -> dict:
        """Get picobot metadata for a skill (cached in frontmatter)."""
        meta = self.get_skill_metadata(name) or {}
        return self._parse_picobot_metadata(meta.get("metadata", ""))
    ...
    def get_always_skills(self) -> list[str]:
        ...
        for s in self.list_skills(filter_unavailable=True):
            ...
            skill_meta = self._parse_picobot_metadata(meta.get("metadata", ""))
