...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install picobot-ai[matrix]"
    ) from e

from picobot.bus.events import OutboundMessage
from picobot.bus.queue import MessageBus
from picobot.channels.base import BaseChannel
from picobot.config.paths import get_data_dir, get_media_dir
from picobot.utils.helpers import safe_filename
